...
$sql_update_panitia=mysqli_query($koneksi,"UPDATE table_desa SET
 kode_desa='$kode_desa',
 desa='$desa',
 kecamatan='$kecamatan',
 ...
 tempat_lahir_saksi_1='$tempat_lahir_saksi_1',
 tanggal_lahir_saksi_1='$tanggal_lahir_saksi_1',
 umur_saksi_1='$umur_saksi_1',
 agama_saksi_1='$agama_saksi_1',
 no_ktp_saksi_1='$no_ktp_saksi_1',
 pekerjaan_saksi_1='$pekerjaan_saksi_1',
 alamat_saksi_1='$alamat_saksi_1',
 nama_saksi_2='$nama_saksi_2',
 tempat_lahir_saksi_2='$tempat_lahir_saksi_2',
 tanggal_lahir_saksi_2='$tanggal_lahir_saksi_2',
 umur_saksi_2='$umur_saksi_2',
 agama_saksi_2='$agama_saksi_2',
 no_ktp_saksi_2='$no_ktp_saksi_2',
 pekerjaan_saksi_2='$pekerjaan_saksi_2',
 alamat_saksi_2='$alamat_saksi_2',
 alamat_kantor_desa='$alamat_kantor_desa',
 nama_ppat='$nama_ppat',
 nama_satgas_1='$nama_satgas_1',
 nip_satgas_1='$nip_satgas_1',
 nama_satgas_2='$nama_satgas_2',
 hari='$hari',
 bulan_tanggal_tahun='$bulan_tanggal_tahun'

  WHERE kode_desa='$kode_desa'") or die (mysqli_error($koneksi));
